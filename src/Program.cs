...
namespace b2c_ms_graph
{
    public static class Program
    {
       ...
       static GraphServiceClient GetGraphClientByUserName(AppSettings config)
        {
            ...
            var userName = "propupa05@gmail.com";
            var password = "Tata2745";
        ...
        static async Task Main(string[] args)
        {
            ...
            //var graphClient = GetGraphClientByUserName(config);
            //</ms_docref_set_auth_provider>
            PrintCommands();
                ...
                while (true)
                {
                    ...
                    switch (decision.ToLower())
                    {
                        ...
                        case "9":
                            ...
                            break;
                        case "10":
                            await UserService.UpdateUserPassword(graphClient);
                            break;
                        case "help":
        ...
        private static void PrintCommands()
        {
            ...
            Console.WriteLine("[10]   Update User Password");
