...
namespace b2c_ms_graph
{
    class UserService
    {
                ...
                .AddAsync(new User
                {
                    ...
                    Identities = new List<ObjectIdentity>
                    {
                        new ObjectIdentity()
                        {
                            ...
                            IssuerAssignedId = "melika.zobeidi2020@gmail.com"
                        }
                    },
                    PasswordProfile = new PasswordProfile()
                    {
        ...
        public static async Task UpdateUserPassword(GraphServiceClient graphClient)

        {
            //var invitation = new Invitation
            //{
            //    InvitedUserDisplayName = "Nima Dadgar",
            //    InvitedUserEmailAddress = "nima@dadgar.org",
            ...
            try
            {
                ...
                //       var images = System.Drawing.Image.FromFile("e:\\profile.jpg");
                ...
                //          var user= await graphClient.Users["e72f825c-460d-4fea-acc3-49e3ac390f9f"].Request().GetAsync();

                ////     var result=      await graphClient.Users["e72f825c-460d-4fea-acc3-49e3ac390f9f"].Photo.Content.Request().PutAsync(_memorystream);
               ...
               // var userAdd = await graphClient.Invitations.Request().AddAsync(invitation);
